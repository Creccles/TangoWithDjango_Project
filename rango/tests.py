...
class Chapter10ViewTests(TestCase):
    ...
    def test_about_view(self):
        ...
        self.assertTrue('Visits: 1' in content,
                        f"{FAILURE_HEADER}In your about.html template, please check that you have the correct output for displaying the number of visits. Capital letters matter. Otherwise, check your about() view and the cookie handling logic.{FAILURE_FOOTER}")
    ...
    def test_visits_passed_via_context(self):
        ...
        self.assertNotIn('visits', response.context,
                         f"{FAILURE_HEADER}The 'visits' variable appeared in the context dictionary passed by index(). This should be removed, as per the exercises for Chapter 10.{FAILURE_FOOTER}")
